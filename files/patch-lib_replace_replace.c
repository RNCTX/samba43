...
--- lib/replace/replace.c.orig	2015-09-08 13:45:25 UTC
+++ lib/replace/replace.c
@@ -541,6 +541,7 @@ long long int rep_strtoll(const char *st
 #undef strtoll
...
+	int errno0 = errno;
 	...
 	if (errno == EINVAL) {
@@ -549,7 +550,7 @@ long long int rep_strtoll(const char *st
...
+			errno = errno0;
 	...
 	return nb;
@@ -572,26 +573,24 @@ unsigned long long int rep_strtoull(cons
 #endif
 }
 #else
